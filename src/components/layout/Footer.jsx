export default function Footer() {
  return (
    <footer className="border-t border-desert-200 bg-desert-900 text-desert-50">
      <div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 py-8 text-sm sm:px-6 md:flex-row md:items-center md:justify-between lg:px-8">
        ...
        <p className="max-w-2xl text-desert-100">
          Local data and browser storage keep RajAtlas ready for source-book
          expansion without a backend.
        </p>
      </div>
    </footer>
  );
