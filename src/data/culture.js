...
export const cultureQuiz = [
  ...
  },
  {
    ...
    type: "mcq",
    category: "Culture",
    question: "Gangaur is best remembered as which type of Rajasthan culture fact?",
    options: ["Festival", "Salt lake", "River tributary", "Assembly committee"],
    correctAnswer: "Festival",
    explanation: "Gangaur is one of Rajasthan's major festivals and is often revised with Teej.",
  },
  {
    id: "cul-kalbeliya",
    type: "mcq",
    category: "Culture",
    question: "Kalbeliya is a famous Rajasthan tradition of which form?",
    options: ["Folk dance", "Marble mining", "Fort planning", "Canal building"],
    correctAnswer: "Folk dance",
    explanation: "Kalbeliya is a high-yield folk dance anchor in Rajasthan culture.",
  },
  {
    id: "cul-blue-pottery",
    type: "mcq",
    category: "Culture",
    question: "Blue pottery is most strongly associated with which city?",
    options: ["Jaipur", "Kota", "Dungarpur", "Churu"],
    correctAnswer: "Jaipur",
    explanation: "Jaipur is the standard city anchor for blue pottery and gems-jewellery craft memory.",
  },
  {
    id: "cul-manganiyar",
    type: "mcq",
    category: "Culture",
    question: "Manganiyar is best remembered with which cultural field?",
    options: ["Folk music", "Wildlife conservation", "High Court practice", "Irrigation engineering"],
    correctAnswer: "Folk music",
    explanation: "Manganiyar musicians are an important folk music tradition of western Rajasthan.",
  },
  {
    id: "cul-kathputli",
    type: "mcq",
    category: "Culture",
    question: "Kathputli is Rajasthan's famous tradition of what?",
    options: ["Puppetry", "Astronomy", "Copper mining", "Lake irrigation"],
    correctAnswer: "Puppetry",
    explanation: "Kathputli is one of Rajasthan's most recognizable folk performance traditions.",
  },
];
